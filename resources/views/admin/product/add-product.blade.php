                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="attributes[0][attribute_id]"
                                                        class="form-control select-attribute" data-index="0"
                                                        id="attribute_0" required>
                                                ...
                                                <div class="col-md-6 attribute-values-container"
                                                    id="attribute-values-container-0">

                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="button" id="add-attribute" class="btn btn-secondary mt-3">Add
                                        Attribute</button>
                                </div>
