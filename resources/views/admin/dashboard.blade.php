                    ...
                    <div class="cr-card revenue-overview">
                        ...
                        <div class="cr-card-content">
                            <div class="cr-chart-header">
                                ...
                                <div class="block">
                                    <h6>Net Revenue</h6>
                                    <h5>{{ $netRevenue < 0 ? '-' : '' }}${{ number_format(abs($netRevenue / 1000), 1) }}k
                                    </h5>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($orderStatuses as $status)
                                                    @php
                                                        ...
                                                        $percentage =
                                                            $totalAmount > 0
                                                                ? ($statusData['amount'] / $totalAmount) * 100
                                                                : 0;
                                                        $countPercentage =
                                                            $totalCount > 0
                                                                ? ($statusData['count'] / $totalCount) * 100
                                                                : 0;
                                                    @endphp
                                                    <tr>
                                                        <td>{{ $status->id }}</td>
                                        ...
                                        <tbody>
                                            @foreach ($recentOrders as $order)
                                                <tr>
                                                    ...
                                                    <td
                                                        class="{{ strtolower($order->status->status_name ?? 'unknown') }}">
    ...
    <script>
                ...
                series: [{
                    ...
                    },
                    {
                        ...
                        data: realData.revenueChartData.map((val, index) => {
                            ...
                            return Math.max(0, parseFloat(val) - parseFloat(realData.expenseChartData[
                                index] || 0));
                        })
                    },
                    {
        ...
        function initDailyRevenueChart() {
            try {
                ...
                var weekDays = {!! isset($dayNames)
                    ? json_encode($dayNames)
