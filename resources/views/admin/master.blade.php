...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Apr 2025 15:30:48 GMT -->
...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/favicon-16x16.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/favicon.ico')}}">
    <link rel="manifest" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/favicons/mstile-150x150.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('theme/prium.github.io/phoenix/v1.22.0/unicons.iconscout.com/release/v4.0.8/css/line.css')}}">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/theme-rtl.min.css')}}" type="text/css" rel="stylesheet" id="style-rtl">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/theme.min.css')}}" type="text/css" rel="stylesheet" id="style-default">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/user-rtl.min.css')}}" type="text/css" rel="stylesheet" id="user-style-rtl">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/user.min.css')}}" type="text/css" rel="stylesheet" id="user-style-default">
    <script>
    ...
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/vendors/leaflet/leaflet.css')}}" rel="stylesheet">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/vendors/leaflet.markercluster/MarkerCluster.css')}}" rel="stylesheet">
    <link href="{{asset('theme/prium.github.io/phoenix/v1.22.0/vendors/leaflet.markercluster/MarkerCluster.Default.css')}}" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        @include('admin.components.layouts.slide')
...
@yield('content')
    ...
    <script src="{{asset('theme/prium.github.io/phoenix/v1.22.0/vendors/leaflet.markercluster/leaflet.markercluster.js')}}"></script>
    <script src="{{asset('theme/prium.github.io/phoenix/v1.22.0/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js')}}"></script>
    ...
    <script src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/js/dashboards/ecommerce-dashboard.js')}}"></script>
  </body>


<!-- Mirrored from prium.github.io/phoenix/v1.22.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Apr 2025 15:32:30 GMT -->
</html>