            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    ...
                    <div id="attributeSelectionStep">
                        <h6 class="mb-3">Bước 1: Chọn thuộc tính</h6>
                        <div class="row">
                            @php
                            ...
                            @foreach($attributes as $attribute)
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-muted">Giữ Ctrl (Windows) hoặc Command (Mac) để chọn nhiều giá trị</small>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div id="variationDetailsStep" style="display: none;">
                        <h6 class="mb-3">Bước 2: Nhập thông tin biến thể</h6>
