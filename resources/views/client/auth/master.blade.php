...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/pages/authentication/card/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Apr 2025 15:38:27 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <script src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/vendors/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/js/config.js') }}"></script>
    ...
    <link href="{{ asset('theme/prium.github.io/phoenix/v1.22.0/vendors/simplebar/simplebar.min.css') }}"
        rel="stylesheet">
    <link rel="stylesheet"
        href="{{ asset('theme/prium.github.io/unicons.iconscout.com/release/v4.0.8/css/line.css') }}">
    ...
    <link href="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/theme.min.css') }}" type="text/css"
        rel="stylesheet" id="style-default">
    <link href="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/user-rtl.min.css') }}" type="text/css"
        rel="stylesheet" id="user-style-rtl">
    <link href="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/css/user.min.css') }}" type="text/css"
    ...
    <main class="main" id="top">
        <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
            <div class="bg-holder bg-auth-card-overlay"
                style="background-image:url({{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/bg/37.png') }});">
            </div>
            <!--/.bg-holder-->
                        ...
                        <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                            ...
                            <div class="text-center mt-auto">
                                <div class="avatar avatar-3xl status-online"><img
                                        ...
                                        src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/team/30.webp')}}" alt="" /></div>
                ...
                <div class="row gx-2">
                    <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-light.png')}}" alt="" /></span><span
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-dark.png')}}" alt="" /></span><span
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/auto.png')}}" alt="" /></span><span
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbarPositionVertical" name="navigation-type"
                            ...
                            for="navbarPositionVertical"> <span class="rounded d-block"><img
                                    ...
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-light.png')}}" alt="" /><img
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-default.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-default-dark.png')}}"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionCombo" name="navigation-type"
                            ...
                            for="navbarPositionCombo"> <span class="rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/nav-combo-light.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/nav-combo-dark.png')}}" alt="" /></span><span
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type"
                            ...
                            for="navbarPositionTopDouble"> <span class="rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/dual-light.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/dual-dark.png')}}" alt="" /></span><span
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbar-style-default" type="radio"
                            ...
                            for="navbar-style-default"> <img class="img-fluid img-prototype d-dark-none"
                                src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-light.png')}}" alt="" /><img
                                class="img-fluid img-prototype d-light-none"
                                src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-dark.png')}}" alt="" /><span
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio"
                            ...
                            for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none"
                                src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/vertical-darker.png')}}" alt="" /><img
                                class="img-fluid img-prototype d-light-none"
                                src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/vertical-lighter.png')}}" alt="" /><span
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape"
                            ...
                            for="navbarShapeSlim"> <span class="mb-2 rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-slim.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-slim-dark.png')}}" alt="" /></span><span
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbarTopDefault" name="navbar-top-style"
                            ...
                            for="navbarTopDefault"> <span class="mb-2 rounded d-block"><img
                                    ...
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-default.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-style-darker.png')}}"
                                    alt="" /></span><span class="label-text">Default</span></label></div>
                    <div class="col-6"><input class="btn-check" id="navbarTopDarker" name="navbar-top-style"
                            ...
                            for="navbarTopDarker"> <span class="mb-2 rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/navbar-top-style-light.png')}}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-style-lighter.png')}}"
