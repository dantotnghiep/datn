...
<head>
    ...
    <link rel="icon" href="/client/assets/images/favicon.png" type="image/png" sizes="20x20" />

    <link rel="stylesheet" href="/client/assets/css/swiper.css" />
    <!-- flaticon -->
    <link rel="stylesheet" href="/client/assets/font/flaticon.css" />
    <!-- Bootstarp icon -->
    <link rel="stylesheet" href="/client/assets/css/bootstrap-icons.css" />
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/client/assets/css/bootstrap.min.css" />
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/client/assets/css/global.css" />
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-md banner-md2 position-relative">
                            <div class="banner-img">
                                <img src="/client/assets/images/banner/banner-md2.png" alt="banner" class="img-fluid" />
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-md banner-md3 position-relative">
                            <div class="banner-img">
                                <img src="/client/assets/images/banner/banner-md3.png" alt="banner" class="img-fluid" />
                            </div>
                            <div class="banner-md-content position-absolute">
                                <div class="banner-md-content-wrap">
                                    <div class="banner-lavel">New Arrivals</div>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-3 col-lg-4">
                        <div class="nav flex-column nav-pills category-tabs" id="v-pills-tab2" role="tablist"
                            ...
                            <button class="nav-link active category-tab" id="eg-pills-1" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-one" type="button" role="tab"
                                aria-controls="eg-pills-one" aria-selected="true">
                                All Collection
                            </button>
                            <button class="nav-link category-tab" id="eg-pills-2" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-two" type="button" role="tab"
                                aria-controls="eg-pills-two" aria-selected="false">
                                Mens Collcetion
                            </button>
                            <button class="nav-link category-tab" id="eg-pills-3" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-three" type="button" role="tab"
                                aria-controls="eg-pills-three" aria-selected="false">
                                Women Collection
                            </button>
                            <button class="nav-link category-tab" id="eg-pills-4" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-four" type="button" role="tab"
                                aria-controls="eg-pills-four" aria-selected="false">
                                Kids Collection
                            </button>
                            <button class="nav-link category-tab" id="eg-pills-5" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-five" type="button" role="tab"
                                aria-controls="eg-pills-five" aria-selected="false">
                                Winter Collection
                            </button>
                            <button class="nav-link category-tab" id="eg-pills-6" data-bs-toggle="pill"
                                data-bs-target="#eg-pills-six" type="button" role="tab"
                                aria-controls="eg-pills-six" aria-selected="false">
                                Summer Collection
                            </button>
                        </div>
                    </div>
                    <div class="col-xxl-9 col-xl-9 col-lg-8">
                        <div class="tab-content eg-tab-content" id="v-pills-tabContent2">
                            <div class="tab-pane fade show active eg-product-tab-pane" id="eg-pills-one"
                                role="tabpanel" aria-labelledby="eg-pills-1">
                                <div class="row">
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            ...
                                            <div class="product-details-m">
                                                <a class="product-title-m" href="product-details.html">Something Navy
                                                    Jens Sale</a>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-2.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                            <div class="product-details-m">
                                                <a class="product-title-m" href="product-details.html">Sports Trouser
                                                    Men Sale</a>
                                                <ul class="d-flex product-rating-m">
                                                    <li><i class="bi bi-star-fill"></i></li>
                                                    <li><i class="bi bi-star-fill"></i></li>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-3.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            ...
                                            <div class="product-details-m">
                                                <a class="product-title-m" href="product-details.html">Lined Zipper
                                                    Hoodie Sale</a>
                                                <ul class="d-flex product-rating-m">
                                                    <li><i class="bi bi-star-fill"></i></li>
                                                    <li><i class="bi bi-star-fill"></i></li>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            ...
                                            <div class="product-details-m">
                                                <a class="product-title-m" href="product-details.html">Ghost Mannequin
                                                    Dress Sale</a>
                                                <ul class="d-flex product-rating-m">
                                                    <li><i class="bi bi-star-fill"></i></li>
                                                    <li><i class="bi bi-star-fill"></i></li>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-7.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-8.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-9.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-10.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-card-m d-flex align-items-center">
                                            <div class="product-img-m">
                                                <a href="product-details.html"><img
                                                        src="/client/assets/images/product/pm-11.png" alt="" /></a>
                                                <div class="product-cart-icon">
                                                    <a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
                                                </div>
                                            </div>
                    ...
                    <div class="swiper-tranding-container overflow-hidden pb-30">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    ...
                                    <div class="product-content-xl text-center">
                                        ...
                                        <a href="product-details.html" class="product-title">Woman Dirty Casual
                                            Dress</a>
                                        <div class="product-price">
                            ...
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    <div class="product-img-xl">
                                        <a href="product-details.html"><img src="/client/assets/images/product/pxl-2.png"
                                                alt="" class="img-fluid" /></a>
                                        <div class="product-actions-xl">
                                            <a href="#"><i class="flaticon-heart"></i></a>
                                            <a href="product-details.html"><i class="flaticon-search"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    <div class="product-img-xl">
                                        <a href="product-details.html"><img src="/client/assets/images/product/pxl-3.png"
                                                alt="" class="img-fluid" /></a>
                                        <div class="product-actions-xl">
                                            <a href="#"><i class="flaticon-heart"></i></a>
                                            <a href="product-details.html"><i class="flaticon-search"></i></a>
                                    ...
                                    <div class="product-content-xl text-center">
                                        ...
                                        <a href="product-details.html" class="product-title">Super Kids
                                            Collection</a>
                                        <div class="product-price">
                                            <del class="old-price">$302.74</del><ins class="new-price">$290.05</ins>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    <div class="product-img-xl">
                                        <a href="product-details.html"><img src="/client/assets/images/product/pxl-4.png"
                                                alt="" class="img-fluid" /></a>
                                        <div class="product-actions-xl">
                                            <a href="#"><i class="flaticon-heart"></i></a>
                                            <a href="product-details.html"><i class="flaticon-search"></i></a>
                                    ...
                                    <div class="product-content-xl text-center">
                                        ...
                                        <a href="product-details.html" class="product-title">Women Mannequin
                                            Tops</a>
                                        <div class="product-price">
                                            <del class="old-price">$302.74</del><ins class="new-price">$290.05</ins>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    <div class="product-img-xl">
                                        <a href="product-details.html"><img src="/client/assets/images/product/pxl-7.png"
                                                alt="" class="img-fluid" /></a>
                                        <div class="product-actions-xl">
                                            <a href="#"><i class="flaticon-heart"></i></a>
                                            <a href="product-details.html"><i class="flaticon-search"></i></a>
                                    ...
                                    <div class="product-content-xl text-center">
                                        ...
                                        <a href="product-details.html" class="product-title">Ghost Mannequin
                                            Pant</a>
                                        <div class="product-price">
                                            <del class="old-price">$302.74</del><ins class="new-price">$290.05</ins>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card-xl">
                                    <div class="product-img-xl">
                                        <a href="product-details.html"><img src="/client/assets/images/product/pxl-6.png"
                                                alt="" class="img-fluid" /></a>
                                        <div class="product-actions-xl">
                                            <a href="#"><i class="flaticon-heart"></i></a>
                                            <a href="product-details.html"><i class="flaticon-search"></i></a>
                        ...
                        <div class="footer-widget footer-about">
                            ...
                            <div class="footer-contact-actions">
                                <div class="footer-action">
                                    <a href="#">168/170, Avenue 01, Mirpur DOHS, Bangladesh</a>
                                </div>
                                <div class="footer-action">
                                    <span>Email : </span><a href="#">
                                        <span class="__cf_email__"
                                            data-cfemail="3e575058517e5b465f534e525b105d5153">[email&#160;protected]</span></a>
                                </div>
                            </div>
                            ...
                            <ul class="footer-social-links d-flex">
                                ...
                                <li>
                                    <a href="#"><i class="flaticon-instagram-1"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-7">
                            <div
                                ...
                                <ul class="payment-options d-flex">
                                    ...
                                    <li>
                                        <img src="/client/assets/images/payment/payment-2.png" alt="" />
                                    </li>
                                    <li>
                                        <img src="/client/assets/images/payment/payment-3.png" alt="" />
                                    </li>
                                    <li>
                                        <img src="/client/assets/images/payment/payment-2.png" alt="" />
                                    </li>
    ...
    <script src="/client/assets/js/swiper.js"></script>
    <script src="/client/assets/js/jquery-ui.min.js"></script>
    <script src="/client/assets/js/jquery.fancybox.min.js"></script>
