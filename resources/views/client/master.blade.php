...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/apps/e-commerce/landing/homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Apr 2025 15:33:16 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="{{ asset('theme/prium.github.io/phoenix/v1.22.0/vendors/swiper/swiper-bundle.min.css') }}"
        rel="stylesheet">
</head>
...
<body>
    ...
    <main class="main" id="top">
        ...
        @include('client.layouts.partials.chat')
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-light.png') }}"
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbarPositionVertical" name="navigation-type"
                            ...
                            for="navbarPositionVertical"> <span class="rounded d-block"><img
                                    ...
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/default-dark.png') }}"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-default.png') }}"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionCombo" name="navigation-type"
                            ...
                            for="navbarPositionCombo"> <span class="rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/nav-combo-light.png') }}"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/nav-combo-dark.png') }}"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type"
                            ...
                            for="navbarPositionTopDouble"> <span class="rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/dual-light.png') }}"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/dual-dark.png') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio"
                            ...
                            for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/vertical-darker.png') }}"
                                alt="" /><img class="img-fluid img-prototype d-light-none"
                                src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/vertical-lighter.png') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape"
                            ...
                            for="navbarShapeSlim"> <span class="mb-2 rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-slim.png') }}"
                                    alt="" /><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/top-slim-dark.png') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarTopDarker" name="navbar-top-style"
                            ...
                            for="navbarTopDarker"> <span class="mb-2 rounded d-block"><img
                                    class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('theme/prium.github.io/phoenix/v1.22.0/assets/img/generic/navbar-top-style-light.png') }}"
                                    alt="" /><img class="img-fluid img-prototype d-light-none mb-0"
...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/apps/e-commerce/landing/homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Apr 2025 15:33:20 GMT -->
