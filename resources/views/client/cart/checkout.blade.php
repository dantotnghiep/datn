            ...
            <div class="col-lg-7 col-xl-7">
                <form action="{{ route('orders.store') }}" method="POST">
                    ...
                    @if(session('applied_voucher'))
                        <input type="hidden" name="voucher_code" value="{{ session('applied_voucher') }}">
                        <input type="hidden" name="voucher_value" value="{{ session('cart_discount') }}">
                    @endif
                    <div class="d-flex align-items-end">
                        <h3 class="mb-0 me-3">Thông tin giao hàng</h3>
                        <button type="button" class="btn btn-outline-primary btn-sm mb-1" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="province"
                                    value="{{ $defaultLocation->province ?? auth()->user()->province }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Quận/Huyện</label>
                                <input type="text" class="form-control" name="district"
                                    value="{{ $defaultLocation->district ?? auth()->user()->district }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Phường/Xã</label>
                                <input type="text" class="form-control" name="ward"
                                    value="{{ $defaultLocation->ward ?? auth()->user()->ward }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Địa chỉ chi tiết</label>
                                <input type="text" class="form-control" name="address"
                                    value="{{ $defaultLocation->address ?? auth()->user()->address }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" id="bank" type="radio" name="payment_method"
                                            value="bank" checked>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" id="cod" type="radio" name="payment_method"
                                            value="cod">
                    ...
                    <div class="row g-2 mt-4">
                        ...
                        <div class="col-md-4 col-lg-3 d-grid">
                            <a href="{{ route('cart') }}" class="btn btn-phoenix-secondary text-nowrap">Quay lại giỏ
                                hàng</a>
                        </div>
                    </div>
                </form>
                                    ...
                                    <div class="row align-items-center mb-2 g-3">
                                        <div class="col-8 col-md-7 col-lg-8">
                                            <div class="d-flex align-items-center">
                                                <img class="me-2 ms-1"
                                                    src="{{ asset(optional($item->productVariation->product->images->first())->image_path ?? 'assets/img/products/default.png') }}"
                                                    width="40" alt="" />
                                                <h6 class="fw-semibold text-body-highlight lh-base">
                                                    {{ $item->productVariation->product->name }}</h6>
                                            </div>
                            ...
                            @if (isset($discount) && $discount > 0)
                                ...
                                @if (session('applied_voucher'))
                                    <div class="d-flex justify-content-between mb-2">
                                        <h5 class="text-body">
                                            <small>Discount: <span
                                                    class="fw-semibold">{{ session('applied_voucher') }}</span></small>
                                        </h5>
                                    </div>
                                @endif
                            @endif
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card h-100 {{ $location->is_default ? 'border-primary' : '' }}">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mb-1">{{ $location->ward }}, {{ $location->district }}
                                            </p>
                                            ...
                                            <div class="mt-2">
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-primary select-address"
                                                ...
                                                @if (!$location->is_default)
                                                    <a href="{{ route('locations.set-default', $location->id) }}"
                ...
                locationDetailButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        fetch(`/locations/${locationId}`)
                            ...
                            .then(data => {
                                document.querySelector('input[name="address"]').value = data
                                .address;
                                document.querySelector('input[name="province"]').value = data
                                    .province;
                                document.querySelector('input[name="district"]').value = data
                                    .district;
