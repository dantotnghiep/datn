    ...
    <div class="row">
        ...
        @if (empty($keywords))
            <div class="col-12 text-center py-5">
                <h4 class="text-muted">Vui lòng nhập từ khóa để tìm kiếm sản phẩm.</h4>
            </div>
        @elseif ($search_product->isEmpty())
            {{-- Nếu không có kết quả tìm kiếm --}}
            <div class="col-12 text-center py-5">
                <h4 class="text-muted">Không có sản phẩm nào phù hợp với từ khóa "{{ $keywords }}".</h4>
            </div>
        @else
            {{-- Danh sách sản phẩm --}}
            ...
            <div class="col-lg-12 mt-50">
                <div class="custom-pagination d-flex justify-content-center">
                    {{ $search_product->withQueryString()->links() }}
                </div>
            </div>
        @endif
    </div>
