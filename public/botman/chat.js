! function(t) {
    ...
    function a(t) {
        return "undefined" != typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(t) : t && t
            .buffer && t.buffer instanceof ArrayBuffer
    }
    ...
    function o(t, e) {
        ...
        for (e && null != e.children && (k.length || k.push(e.children), delete e.children); k.length;)
            ...
            else "boolean" == typeof o && (o = null), (i = "function" != typeof t) && (null == o ? o = "" :
                "number" == typeof o ? o += "" : "string" != typeof o && (i = !1)), i && n ? s[s
                .length - 1] += o : s === D ? s = [o] : s.push(o), n = i;
        var c = new r;
        return c.nodeName = t, c.children = s, c.attributes = null == e ? void 0 : e, c.key = null == e ?
            void 0 : e.key, void 0 !== E.vnode && E.vnode(c), c
    }
    ...
    function c(t, e, n) {
        return "string" == typeof e || "number" == typeof e ? void 0 !== t.splitText : "string" == typeof e
            .nodeName ? !t._componentConstructor && u(t, e.nodeName) : n || t._componentConstructor === e
            .nodeName
    }
    ...
    function d(t, e, n, r, o) {
        if ("className" === e && (e = "class"), "key" === e);
            ...
            if ("style" === e) {
                if (r && "string" != typeof r && "string" != typeof n || (t.style.cssText = r || ""), r &&
                    "object" == typeof r) {
                    if ("string" != typeof n)
                        for (var i in n) i in r || (t.style[i] = "");
                    for (var i in r) t.style[i] = "number" == typeof r[i] && !1 === B.test(i) ? r[i] +
                        "px" : r[i]
                }
            } else if ("dangerouslySetInnerHTML" === e) r && (t.innerHTML = r.__html || "");
        else if ("o" == e[0] && "n" == e[1]) {
            var a = e !== (e = e.replace(/Capture$/, ""));
            e = e.toLowerCase().substring(2), r ? n || t.addEventListener(e, m, a) : t.removeEventListener(
                e, m, a), (t._listeners || (t._listeners = {}))[e] = r
        } else if ("list" !== e && "type" !== e && !o && e in t) h(t, e, null == r ? "" : r), null != r && !
            1 !== r || t.removeAttribute(e);
        else {
            var s = o && e !== (e = e.replace(/^xlink\:?/, ""));
            null == r || !1 === r ? s ? t.removeAttributeNS("http://www.w3.org/1999/xlink", e
                .toLowerCase()) : t.removeAttribute(e) : "function" != typeof r && (s ? t
                .setAttributeNS(
                    "http://www.w3.org/1999/xlink", e.toLowerCase(), r) : t.setAttribute(e, r))
        } else t.className = r || ""
    }
    ...
    function y() {
        for (var t; t = R.pop();) E.afterMount && E.afterMount(t), t.componentDidMount && t
            .componentDidMount()
    }
    ...
    function b(t, e, n, r, o) {
        ...
        if (null != e && "boolean" != typeof e || (e = ""), "string" == typeof e || "number" == typeof e)
            return t && void 0 !== t.splitText && t.parentNode && (!t._component || o) ? t.nodeValue != e &&
                (t.nodeValue = e) : (i = document.createTextNode(e), t && (t.parentNode && t.parentNode
                    .replaceChild(i, t), _(t, !0))), i.__preactattr_ = !0, i;
        var s = e.nodeName;
        ...
        return !I && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c
            .splitText && null == c.nextSibling ? c.nodeValue != f[0] && (c.nodeValue = f[0]) : (f && f
                .length || null != c) && g(i, f, n, r, I || null != p.dangerouslySetInnerHTML), w(i, e
                .attributes, p), q = a, i
    }
    ...
    function g(t, e, n, r, o) {
        ...
        if (0 !== v)
            for (var w = 0; v > w; w++) {
                ...
                null != T ? (m++, h[T] = O) : (C || (void 0 !== O.splitText ? !o || O.nodeValue.trim() :
                    o)) && (d[g++] = O)
            }
        if (0 !== x)
            for (var w = 0; x > w; w++) {
                ...
                if (null != T) m && void 0 !== h[T] && (p = h[T], h[T] = void 0, m--);
                    ...
                    for (i = y; g > i; i++)
                        if (void 0 !== d[i] && c(a = d[i], u, o)) {
                            ...
                            break
                        } p = b(p, u, n, r), s = l[w], p && p !== t && p !== s && (null == s ? t
                    .appendChild(p) : p === s.nextSibling ? f(s) : t.insertBefore(p, s))
            }
        if (m)
    ...
    function _(t, e) {
        var n = t._component;
        n ? S(n) : (null != t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null), !1 !== e &&
            null != t.__preactattr_ || f(t), x(t))
    }
    ...
    function w(t, e, n) {
        ...
        for (r in e) "children" === r || "innerHTML" === r || r in n && e[r] === ("value" === r ||
            "checked" === r ? t[r] : n[r]) || d(t, r, n[r], n[r] = e[r], q)
    }
    ...
    function C(t, e, n) {
        var r, o = F[t.name];
        if (t.prototype && t.prototype.render ? (r = new t(e, n), A.call(r, e, n)) : (r = new A(e, n), r
                .constructor = t, r.render = T), o)
    ...
    function j(t, e, n, r, o) {
        t._disable || (t._disable = !0, (t.__ref = e.ref) && delete e.ref, (t.__key = e.key) && delete e
            .key, !t.base || o ? t.componentWillMount && t.componentWillMount() : t
            .componentWillReceiveProps && t.componentWillReceiveProps(e, r), r && r !== t.context && (t
                .prevContext || (t.prevContext = t.context), t.context = r), t.prevProps || (t
                .prevProps = t.props), t.props = e, t._disable = !1, 0 !== n && (1 !== n && !1 === E
                .syncComponentUpdates && t.base ? a(t) : M(t, 1, o)), t.__ref && t.__ref(t))
    }
    ...
    function M(t, e, n, r) {
        if (!t._disable) {
            ...
            if (m && (t.props = f, t.state = d, t.context = h, 2 !== e && t.shouldComponentUpdate && !1 ===
                    t.shouldComponentUpdate(c, u, l) ? w = !0 : t.componentWillUpdate && t
                    .componentWillUpdate(c, u, l), t.props = c, t.state = u, t.context = l), t.prevProps = t
                .prevState = t.prevContext = t.nextBase = null, t._dirty = !1, !w) {
                o = t.render(c, u, l), t.getChildContext && (l = i(i({}, l), t.getChildContext()));
                var O, T, N = o && o.nodeName;
                if ("function" == typeof N) {
                    var A = p(o);
                    a = x, a && a.constructor === N && A.key == a.__key ? j(a, A, 1, l, !1) : (O = a, t
                        ._component = a = C(N, A, l), a.nextBase = a.nextBase || b, a._parentComponent =
                        t, j(a, A, 0, l, !1), M(a, 1, n, !0)), T = a.base
                } else s = g, O = x, O && (s = t._component = null), (g || 1 === e) && (s && (s._component =
                    null), T = v(s, o, l, n || !m, g && g.parentNode, !0));
                if (g && T !== g && a !== x) {
                    var P = g.parentNode;
            ...
            if (!m || n ? R.unshift(t) : w || (t.componentDidUpdate && t.componentDidUpdate(f, d, h), E
                    .afterUpdate && E.afterUpdate(t)), null != t._renderCallbacks)
    ...
    function N(t, e, n, r) {
        for (var o = t && t._component, i = o, a = t, s = o && t._componentConstructor === e.nodeName, c =
                s, u = p(e); o && !c && (o = o._parentComponent);) c = o.constructor === e.nodeName;
        return o && c && (!r || o._component) ? (j(o, u, 3, n, r), t = o.base) : (i && !s && (S(i), t = a =
            null), o = C(e.nodeName, u, n), t && !o.nextBase && (o.nextBase = t, a = null), j(o, u,
            1, n, r), t = o.base, a && t !== a && (a._component = null, _(a, !1))), t
    }
    ...
    function S(t) {
        ...
        var n = t._component;
        n ? S(n) : e && (e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null), t.nextBase =
            e, f(e), O(t), x(e)), t.__ref && t.__ref(null)
    }
    ...
    i(A.prototype, {
        setState: function(t, e) {
            var n = this.state;
            this.prevState || (this.prevState = i({}, n)), i(n, "function" == typeof t ? t(n,
                    this.props) : t), e && (this._renderCallbacks = this._renderCallbacks || [])
                .push(e), a(this)
        },
    ...
    var o = n(0),
        ...
        s = {
            adapter: function() {
                var t;
                return "undefined" != typeof XMLHttpRequest ? t = n(4) : "undefined" !=
                    typeof process && (t = n(4)), t
            }(),
            transformRequest: [function(t, e) {
                return i(e, "Content-Type"), o.isFormData(t) || o.isArrayBuffer(t) || o.isBuffer(
                        t) || o.isStream(t) || o.isFile(t) || o.isBlob(t) ? t : o.isArrayBufferView(
                        t) ?
                    t.buffer : o.isURLSearchParams(t) ? (r(e,
                        "application/x-www-form-urlencoded;charset=utf-8"), "" + t) : o.isObject(
                        t) ? (r(e, "application/json;charset=utf-8"), JSON.stringify(t)) : t
            }],
    ...
    t.exports = function(t) {
        return new Promise(function(e, p) {
            ...
            var d = new XMLHttpRequest,
                ...
                m = !1;
            if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in
                d || s(t.url) || (d = new window.XDomainRequest, h = "onload", m = !0, d
                    .onprogress = function() {}, d.ontimeout = function() {}), t.auth) {
                f.Authorization = "Basic " + u((t.auth.username || "") + ":" + (t.auth
                    .password || ""))
            }
            if (d.open(t.method.toUpperCase(), i(t.url, t.params, t.paramsSerializer), !0), d
                .timeout = t.timeout, d[h] = function() {
                    if (d && (4 === d.readyState || m) && (0 !== d.status || d.responseURL &&
                            0 === d.responseURL.indexOf("file:"))) {
                        var n = "getAllResponseHeaders" in d ? a(d.getAllResponseHeaders()) :
                            null;
                        o(e, p, {
                            data: t.responseType && "text" !== t.responseType ? d
                    ...
                    p(c("timeout of " + t.timeout + "ms exceeded", t, "ECONNABORTED", d)), d =
                        null
                }, r.isStandardBrowserEnv()) {
                var y = n(21),
                    v = (t.withCredentials || s(t.url)) && t.xsrfCookieName ? y.read(t
                        .xsrfCookieName) : void 0;
                v && (f[t.xsrfHeaderName] = v)
            }
            if ("setRequestHeader" in d && r.forEach(f, function(t, e) {
                    void 0 === l && "content-type" === e.toLowerCase() ? delete f[e] : d
            ...
            "function" == typeof t.onDownloadProgress && d.addEventListener("progress", t
                    .onDownloadProgress), "function" == typeof t.onUploadProgress && d.upload &&
                d.upload.addEventListener("progress", t.onUploadProgress), t.cancelToken && t
                .cancelToken.promise.then(function(t) {
    ...
    e.a = function(t) {
        ...
        return o(e, t), e.prototype.componentDidMount = function() {
            var t = this;
            setTimeout(function() {
                t.state.visible = !0, t.state.visibilityChanged = !0, t
                    .onVisibilityChange(), t.props.onVisibilityChange(t.props.message, t
                        .state)
    ...
    t.exports = function(t, e, n) {
        ...
        n.status && o && !o(n.status) ? e(r("Request failed with status code " + n.status, n.config,
            null, n.request, n)) : t(n)
    }
}, function(t) {
    "use strict";
    ...
    t.exports = function(t, e, n) {
        ...
        if (n) i = n(e);
            ...
            o.forEach(e, function(t, e) {
                null !== t && void 0 !== t && (o.isArray(t) ? e += "[]" : t = [t], o.forEach(t,
                    function(t) {
                        o.isDate(t) ? t = t.toISOString() : o.isObject(t) && (t = JSON
                            .stringify(t)), a.push(r(e) + "=" + r(t))
                    }))
            }), i = a.join("&")
        }
    ...
    t.exports = function(t) {
        ...
        return t ? (r.forEach(t.split("\n"), function(t) {
            if (i = t.indexOf(":"), e = r.trim(t.substr(0, i)).toLowerCase(), n = r.trim(t
                    .substr(i + 1)), e) {
                if (a[e] && o.indexOf(e) >= 0) return;
                a[e] = "set-cookie" === e ? (a[e] ? a[e] : []).concat([n]) : a[e] ? a[e] +
                    ", " + n : n
            }
        }), a) : a
    }
    ...
    function n(t) {
        for (var n, o, i = t + "", a = "", s = 0, c = r; i.charAt(0 | s) || (c = "=", s % 1); a += c.charAt(
                63 & n >> 8 - s % 1 * 8)) {
    ...
    t.exports = r.isStandardBrowserEnv() ? function() {
        return {
            write: function(t, e, n, o, i, a) {
                var s = [];
                s.push(t + "=" + encodeURIComponent(e)), r.isNumber(n) && s.push("expires=" +
                        new Date(n).toGMTString()), r.isString(o) && s.push("path=" + o), r
                    .isString(i) && s.push("domain=" + i), !0 === a && s.push("secure"), document
                    .cookie = s.join("; ")
            },
            read: function(t) {
    ...
    var o = n(0),
        ...
        u = n(26);
    t.exports = function(t) {
        return r(t), t.baseURL && !c(t.url) && (t.url = u(t.baseURL, t.url)), t.headers = t.headers ||
            {}, t.data = i(t.data, t.headers, t.transformRequest), t.headers = o.merge(t.headers
                .common || {}, t.headers[t.method] || {}, t.headers || {}), o.forEach(["delete", "get",
                ...
                return a(e) || (r(t), e && e.response && (e.response.data = i(e.response.data, e
                    .response.headers, t.transformResponse))), Promise.reject(e)
            })
    }
}, function(t, e, n) {
    "use strict";
   ...
   function r() {
        ...
        t.id = "botmanChatRoot";
        t.style.height = "90%";  // Thêm style height: 90%
    ...
    e.a = function(t) {
        function e(n) {
            ...
            r.messagesLoaded = false;

            r.loadMessages = function () {
                if (r.messagesLoaded) {
                    return;
                }
                fetch('/get-chat-messages')
                    ...
                    .then(data => {
                        if (data) {
                            r.state.messages = Array.isArray(data.messages) ? data.messages : [];
                            r.state.messages.forEach(message => {
                                r.setState({
                                    messages: r.state.messages
                                });
                            })
                            r.messagesLoaded = true;
                        }
                    })
                    .catch(error => console.error('Không thể lấy tin nhắn:', error));
            };

            r.saveMessages = function () {
                let lastMessageVisitor = null;
                const lastMessage = r.state.messages[r.state.messages.length - 1];
                if (lastMessage.from == "visitor") {
                    lastMessageVisitor = lastMessage;
                }
                if(lastMessage.text == "<span>Hội thoại đã kết thúc, cảm ơn Quý khách đã tin dùng sản phẩm dịch vụ của SHOP.</span>"){
                ...
                if (user_id) {
                    headers['Authorization'] = `userid ${user_id}`;
                }
                fetch('/save-chat-messages', {
                    method: 'POST',
                    headers: headers,
                    body: JSON.stringify({ message: r.state.messages, lastMessage: lastMessageVisitor })
                })
                .then(response => response.json())
                .then(data => {
                    if(!data.success){
                ...
                .catch(error => console.error('Không thể lưu tin nhắn:', error));
            };

            r.handleKeyPress = function (t) {
                if (13 === t.keyCode && r.input.value.replace(/\s/g, "")) {
                    r.say(r.input.value);
                    r.input.value = "";
                }
            };
            ...
            r.writeToMessages = function (t) {
                if (void 0 === t.time) t.time = (new Date).toJSON();
                if (void 0 === t.visible) t.visible = !1;
                if (void 0 === t.timeout) t.timeout = 0;
                if (void 0 === t.id) t.id = e.generateUuid();
                if (null === t.attachment) t.attachment = {};
                if (!Array.isArray(r.state.messages)) {
                    r.state.messages = [];
                }
                const messageExists = r.state.messages.some(msg => msg.id === t.id || msg.time === t.time);
                if (messageExists) {
                    return;
                }
                if(t.text == "<span>Hội thoại đã kết thúc, cảm ơn Quý khách đã tin dùng sản phẩm dịch vụ của SHOP.</span>"){
                    r.messagesLoaded = false;
                    r.loadMessages();
                }

                // Thêm tin nhắn vào trạng thái
                ...
                if (t.additionalParameters && t.additionalParameters.replyType) {
                    r.setState({
        ...
        return a(e, t), e.prototype.componentDidMount = function() {
            ...
            return Object(r.b)("div", {
                ...
                this.state.replyType === s.Text ? Object(r.b)("div", {
                ...
                this.state.replyType === s.TextArea ? Object(r.b)("div", null,
                    Object(r.b)("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                        x: "0px",
                        y: "0px",
    ...
    e.a = function(t) {
        function e() {
            ...
            return e.scrollToBottom = function() {
                ...
                r.id === t.id && r.visible !== n.visible && (r.visible = n.visible, r.timeout = 0, e
                    .forceUpdate())
            }, e
        }
        return p(e, t), e.prototype.componentDidMount = function() {
            ...
            return Object(r.b)("li", {
                ...
                class: "time"
            }, 864e5 > e.getMilliseconds() - a.getMilliseconds() ? o(a, t.conf
                .timeFormat) : o(a, t.conf.dateTimeFormat)) : ""))
        }, e
    }(r.a)
}, function(t, e, n) {
    var r;
    ! function() {
        ...
        function s(t) {
            return null === t ? "null" : void 0 === t ? "undefined" : "object" != typeof t ? typeof t :
        ...
        var c = function() {
            ...
            return function(r, u, p, l) {
                if (1 !== arguments.length || "string" !== s(r) || /\d/.test(r) || (u = r, r =
                        void 0), r = r || new Date, r instanceof Date || (r = new Date(r)), isNaN(
                        r)) throw TypeError("Invalid date");
                ...
                var d = p ? "getUTC" : "get",
                    ...
                    T = {
                        ...
                        o: (w > 0 ? "-" : "+") + o(100 * Math.floor(Math.abs(w) / 60) + Math.abs(
                            w) % 60, 4),
                        S: ["th", "st", "nd", "rd"][h % 10 > 3 ? 0 : (h % 100 - h % 10 != 10) * h %
                            10
                        ],
                        W: O,
                        N: C
    ...
    e.a = function(t) {
        ...
        return a(e, t), e.prototype.render = function(t) {
            ...
            return Object(r.b)("div", null, n.text && Object(r.b)("div", null, n.text), this.state
                .attachmentsVisible ? Object(r.b)("div", null, o) : "")
    ...
    e.a = function(t) {
        function e() {
            ...
            return e.onVisibilityChange = function() {
                setTimeout(function() {
                    e.state.visible = !1, e.props.onVisibilityChange(e.props.message, e
                        .state)
            ...
            var e = this,
                ...
                i = n.elements.map(function(t) {
                    ...
                    return Object(r.b)("div", {
                        ...
                        src: t.image_url
                    }), Object(r.b)("p", null, t.title), Object(r.b)("p", null, t
                        .subtitle), n)
                });
