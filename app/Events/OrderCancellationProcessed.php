...
class OrderCancellationProcessed implements ShouldBroadcast
{
     ...
     */
    public function __construct(OrderCancellation $cancellation, string $status)
    {
        $this->cancellation = $cancellation;
        $this->status = $status; // 'approved' hoặc 'rejected'
    }
