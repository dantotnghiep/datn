...
class ProductController extends Controller
{
    ...
    public function listproduct()
    {
        ...
        $products = Product::with(['variations', 'images', 'category'])->orderBy('created_at', 'desc')->paginate(2);
        return view('client.product.list-product', compact('products', 'categories'));
    }
